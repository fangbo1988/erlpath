-file("/usr/local/Cellar/erlang@21/21.3.8.15/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-module(erlpath_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 66).
strip(TokenChars, TokenLen) ->
    lists:sublist(TokenChars, 2, TokenLen - 2).
-file("/usr/local/Cellar/erlang@21/21.3.8.15/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.erl", 309).
yystate() -> 7.
...
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 39).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/0}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 43).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/1}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 46).
yyaction_2(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 47).
yyaction_3(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 48).
yyaction_4(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 49).
yyaction_5(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_6/2}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 52).
yyaction_6(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_7/2}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 53).
yyaction_7(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_8/0}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 55).
yyaction_8() ->
     skip_token .

-compile({inline,yyaction_9/3}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 56).
yyaction_9(TokenChars, TokenLen, TokenLine) ->
     String = strip (TokenChars, TokenLen),
     { token, { binary, TokenLine, list_to_binary (String) } } .

-compile({inline,yyaction_10/2}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 58).
yyaction_10(TokenChars, TokenLine) ->
     { token, { variable, TokenLine, TokenChars } } .

-compile({inline,yyaction_11/0}).
-file("/Users/fangbo/Code/erlpath/src/erlpath_lexer.xrl", 62).
yyaction_11() ->
     skip_token .

-file("/usr/local/Cellar/erlang@21/21.3.8.15/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
